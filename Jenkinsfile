...
//         FRONTEND_IMAGE = 'automarkly/emailservice-frontend'
//         WORKER_IMAGE = 'automarkly/emailservice-worker'
//     }
...
EOF
                    ...
                    curl -f http://localhost:80 || echo "Frontend not responding"
